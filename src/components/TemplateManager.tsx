            ...
            <div>
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-3 gap-2">
                  {['Enter', 'research', 'Luminaries', 'panelist', 'Consumers', 'competitors', 'Colleagues', 'cultural', 'social', 'Grade', 'Findings'].map((step) => (
                    <label key={step} className="flex items-center gap-2 p-2 border-2 border-gray-300 rounded cursor-pointer hover:bg-gray-50">
                      <input
                        type="checkbox"
                        checked={editingTemplate.visibleSteps.includes(step)}
                        onChange={(e) => {
                          if (e.target.checked) {
                            setEditingTemplate({
                              ...editingTemplate,
...
export const defaultTemplates: UserTemplate[] = [
  {
    ...
    role: 'administrator',
    visibleSteps: ['Enter', 'research', 'Luminaries', 'panelist', 'Consumers', 'competitors', 'Colleagues', 'cultural', 'social', 'Grade', 'Findings'],
    questionConfig: {
      Enter: {
  ...
  },
  {
    ...
    visibleSteps: ['Enter', 'research', 'Luminaries', 'Consumers', 'competitors', 'Grade', 'Findings'],
    questionConfig: {
      Enter: {
        visibleQuestions: [0, 1],
        defaultResponses: {},
  ...
  },
  {
    ...
    visibleSteps: ['Enter', 'research', 'Luminaries', 'panelist', 'Consumers', 'competitors', 'Colleagues', 'Grade', 'Findings'],
    questionConfig: {
      Enter: {
        visibleQuestions: [0, 1],
        defaultResponses: {},
  ...
  },
  {
    ...
    role: 'marketing-manager',
    visibleSteps: ['Enter', 'Grade', 'cultural', 'Colleagues', 'panelist', 'Luminaries', 'Consumers', 'competitors', 'social', 'Findings'],
    questionConfig: {
      Enter: {
        visibleQuestions: [0, 1],
        defaultResponses: {},
  ...
  },
  {
    ...
    visibleSteps: ['Enter', 'research', 'panelist', 'Consumers', 'Grade', 'Findings'],
    questionConfig: {
      Enter: {
        visibleQuestions: [0, 1],
        defaultResponses: {
